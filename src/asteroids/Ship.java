...
class Ship extends SpaceThing {
    ...
    public void explode() {
        ...
        String str = String.valueOf(r1) + " x " + String.valueOf(r2) + " = ?";
        String ans = JOptionPane.showInputDialog(null, str , "Answer", JOptionPane.INFORMATION_MESSAGE).trim();
        
        try {
             if (Integer.parseInt(ans) == (r1 * r2)) {
            this.incScore += 10;
        } else {
            System.out.println("Incorrect answer" );
            JOptionPane.showMessageDialog(null, "Incorrect answer the correct answer is " + String.valueOf(r1 * r2), "Incorrect", JOptionPane.WARNING_MESSAGE);
        }
            
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error: you did not type a number please try again ", "retry", JOptionPane.ERROR_MESSAGE);
        }
