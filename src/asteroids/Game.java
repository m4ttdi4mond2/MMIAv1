 ...
 * etc.
 */
class Game implements mmia.intfLeaderboard {
    ...
    public void gameOver() {
        ...
        try {
            mmia.GlDatabase db = new mmia.GlDatabase();
            db.appendToFile(score, GAMELOG, mmia.NewJFrame.currentUser.getEmail());
            
           
        } catch (Exception e) {
        }
       if (mmia.Game.hs < score){
           mmia.Game.hs = score;
       }
    }
    ...
    public void drawMenu() {
        ...
        canvas.text("Meteor Madness", canvas.width/2, 40);

        canvas.text("By Matthew Diamond", canvas.width/2, 60);
        canvas.text("matthewdia@bisphuket.ac.th", canvas.width/2, 75);
    ...
    public void drawGameOver() {
        ...
        canvas.text("", canvas.width/2, 80);
        canvas.text("Press Enter", canvas.width/2, 95);
    }
    ...
    public void drawObjects() {
        ...
        while(li.hasNext()) {
            ...
            if(x instanceof Ship) {
                ...
                if (ship.incScore > 0) score += ship.incScore;
